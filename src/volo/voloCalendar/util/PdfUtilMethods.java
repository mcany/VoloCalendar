 ...
 */
public class PdfUtilMethods {
    public static void main(String[] args) {
        String path = PdfUtilMethods.monthlyReport(2014, 1);
    }
    public static String monthlyReport(int year, int month){
        //file path
        String path = "D:/temp/monthlyReport.pdf";
    ...
    public static String overviewReport(){
        //file path
        String path = "D:/temp/overviewReport.pdf";
        Document doc = new Document();
        PdfWriter docWriter = null;
        ...
        try {
            ...
            ArrayList<User> users = Backend.getActiveDrivers();
            //just some random data to fill
            for(User user: users){
                insertCell(table, user.getName(), Element.ALIGN_RIGHT, 1, bf12);
